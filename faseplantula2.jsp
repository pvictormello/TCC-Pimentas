<%-- 
    Document   : faseplantula2
    Created on : 16/11/2014, 12:13:53
    Author     : Valdomiro
--%>
...
<html>
    ...
    <body>
	   ...
	   <%-- <li class=""><a href=""><% out.print(res.traduz(225,traducao));%></a></li>
        ...
        <ul id="nav3">
            <li class="active"><a href="faseplantula2.jsp"><% out.print(res.traduz(4,traducao));%></a></li>
            <li class=""><a href="fasevegetativa2.jsp"><% out.print(res.traduz(28,traducao));%></a></li>
            <li class=""><a href="fasereprodutiva2.jsp"><% out.print(res.traduz(67,traducao));%></a></li>
        </ul>
            ...
            <%
                ...
                if(session.getValue("codigo")!=null){
                   ...
                   cod = Integer.parseInt(request.getParameter("sel"));
                }
		...
		<form id="contactform" name="f" class="rounded" method="post" action="fasevegetativa2.jsp">
