<%-- 
    Document   : GeraPdf
    Created on : 24/02/2015, 19:41:27
    Author     : Valdomiro
--%>
<%@page import="meupacote.rodape"%>
...
<% 
      ...
      if(session.getValue("loginUsuario") == null && session.getValue("senhaUsuario") == null){
       ...
       {
           String permi= (String) session.getValue("permissaoUsuario");
           String array2[] = new String[4];  
           array2 = permi.split("-");
           if(array2[2].toString().charAt(0)!='1'){
             response.sendRedirect("Home.jsp");
           }else{
     ...
     //String RESULT = "C:\\Users\\Valdomiro\\Documents\\NetBeansProjects\\SistemaGermo\\web\\pdfs\\relatorio.pdf";
    ...
    try { 
        ...
        //PdfWriter.getInstance(document, new FileOutputStream("C:\\Users\\Valdomiro\\Documents\\NetBeansProjects\\SistemaGermo\\web\\pdfs\\relatorio.pdf"));
        ...
        try{
            ...
            //Image img = Image.getInstance("C:\\Users\\Valdomiro\\Documents\\NetBeansProjects\\SistemaGermo\\web\\imagens\\logo.png");
         ...
         Paragraph p1 = new Paragraph(res.traduz(258,traducao)+" ",f);// adicionando um parÃ¡grafo ao documento
         p1.setAlignment(Element.ALIGN_CENTER);
         p1.setSpacingAfter(20); //Solta espaÃ§amento depois do paragrafo
         document.add(p1);
     ...
     //-----------------------Data do relatorio-------------------------------------//
       ...
       String sHora = hformatador.format(dataAtual);
        ...
        //-------------------Gerando o cabecalho e paginacao------------------------------//
