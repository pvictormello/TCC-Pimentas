       ...
       //---------------Cria estilos de fontes diferentes-------------------//
        ...
        try{
         ...
         try { 
              ...
              rs = st.executeQuery("select* from local_coleta as l,faseplantula as fp, fasevegetativa as fv,fasereprodutiva as fr where l.Codigo=fp.ID_Plantula and fp.ID_Plantula=fv.Identificador and fv.Identificador=fr.Identif and especie='"+escolha+"' ");
