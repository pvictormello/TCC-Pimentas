<%-- 
    Document   : localizacao2
    Created on : 16/11/2014, 12:12:41
    Author     : Valdomiro
--%>
...
<html>
    ...
    <body>
        ...
        <!---Abas---------->
        <ul id="nav2">
            <li class="active"><a href="localizacao2.jsp" ><% out.print(res.traduz(223,traducao));%></a></li>
	    <li class=""><a href="faseplantula2.jsp"><% out.print(res.traduz(224,traducao));%></a></li>
		...
		<form id="contactform" name="f2" class="rounded" method="post" action="faseplantula2.jsp">
