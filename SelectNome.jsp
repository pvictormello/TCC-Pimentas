<%-- 
    Document   : SelectNome
    Created on : 28/05/2015, 14:09:14
    Author     : Valdomiro
--%>
...
<html>
    ...
    <% 
        ...
        try { 
              ...
              rs = st.executeQuery("select nome from usuario where nome <>''");
              
              %>
			  <input type="hidden" name="tradu" id="trad" value="<% out.print(res.traduz(285,traducao)); %>"/>
                 <div class="container">

	     <form id="contactform" name="f1" class="rounded" method="post" action="Run.jsp" onSubmit="return selecao(); return false;">
                         ...
                         <option value="0"><% out.print(res.traduz(192,traducao)); %>..</option>
                            <%          
                                    while(rs.next())
                                    {
                                        ...
                                        %>
                                        <option value="<% out.print(rs.getString("nome")); %>"  title="" name="nome"><% out.print(rs.getString("nome")); %></option>
                                        <%
