<%-- 
    Document   : fasevegetativa2
    Created on : 16/11/2014, 12:15:25
    Author     : Valdomiro
--%>
    ...
    <body>
       ...
       <%-- <jsp:useBean id="res" class="meupacote.processa" />--%>
        ...
        <ul id="nav3">
            ...
            <li class="active"><a href="fasevegeativa2.jsp"><% out.print(res.traduz(28,traducao));%></a></li>
		...
		<form id="contactform" name="f" class="rounded" method="post" action="fasereprodutiva2.jsp">
