<%-- 
    Document   : SelectCidade
    Created on : 28/05/2015, 14:06:49
    Author     : Valdomiro
--%>
...
<html>
    ...
    <% 
        ...
        try { 
              ...
              rs = st.executeQuery("select cidade from usuario where cidade <>'' group by cidade");
              
              %>
			  <input type="hidden" name="tradu" id="trad" value="<% out.print(res.traduz(285,traducao)); %>"/>
                 <div class="container">

	     <form id="contactform" name="f1" class="rounded" method="post" action="Ruc.jsp" onSubmit="return selecao(); return false;">
                         ...
                         <option value="0"><% out.print(res.traduz(192,traducao)); %>..</option>
                            <%          
                                    while(rs.next())
                                    {
                                        ...
                                        %>
                                        <option value="<% out.print(rs.getString("cidade")); %>"  title="" name="cidade"><% out.print(rs.getString("cidade")); %></option>
                                        <%
