<%-- 
    Document   : SelectEspecie
    Created on : 07/05/2015, 18:05:55
    Author     : Valdomiro
--%>
...
<% 
      ...
      if(session.getValue("loginUsuario") == null && session.getValue("senhaUsuario") == null){
       ...
       }else 
       {
           ...
           array2 = permis.split("-");
           if(array2[3].toString().charAt(2)=='0'){
             response.sendRedirect("Home.jsp");
           }
       }
 %>
...
<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>
    ...
    <% 
        ...
        try { 
              ...
              rs = st.executeQuery("select especie from local_coleta where especie <> ' '  group by especie order by especie");
	     ...
	     <form id="contactform" name="f1" class="rounded" method="post" action="RelatorioEspecie.jsp" onSubmit="return selecao(); return false;">
                         ...
                         <option value="0"><% out.print(res.traduz(192,traducao)); %>..</option>
                            <%          
                                    while(rs.next())
                                    {
                                        ...
                                        %>
                                        <option value="<% out.print(rs.getString("especie")); %>"  title="" name="esp"><% out.print(rs.getString("especie")); %></option>
                                        <%
