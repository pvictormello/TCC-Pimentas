<%-- 
    Document   : fasereprodutiva
    Created on : 15/11/2014, 18:11:19
    Author     : Valdomiro
--%>
...
<html>
    ...
    <body>
	   ...
	   <%-- <li class=""><a href="#"><% out.print(res.traduz(225,traducao));%></a></li>
        ...
        <ul id="nav3">
            ...
            <li class="active"><a href="fasereprodutiva.jsp"><% out.print(res.traduz(67,traducao));%></a></li>
        </ul>
		...
		<form id="contactform" name="f" class="rounded" method="post" action="imagens.jsp">
                ...
                <div class="field">
                    ...
                    <table>
                            ...
                            if(rs.getString("cod99").equals("1"))
                                            {%>
                                              <td><input type="radio" name="cod99" value="0" checked disabled />  0-<% out.print(res.traduz(100,traducao));%></td>
                                            <% }else
                                              { %>
                                                <td><input type="radio" name="cod99" value="0" disabled />  0-<% out.print(res.traduz(100,traducao));%></td>
                                             <% } %>
                            ...
                            <tr>
                                ...
                                if(rs.getString("cod99").equals("2"))
                                                {%>
                                                  <td><input type="radio" name="cod99" value="1" checked disabled />  1-<% out.print(res.traduz(101,traducao));%></td>
                                                <% }else
                                                  { %>
                                                    <td><input type="radio" name="cod99" value="1" disabled />  1-<% out.print(res.traduz(101,traducao));%></td>
                                                 <% } %>
                    ...
                    <table>
                            ...
                            <tr>
                                ...
                                if(rs.getString("cod102").equals("1"))
                                                {%>
                                                   <td><input type="radio" name="cod102" value="0" checked disabled />  0-<% out.print(res.traduz(100,traducao));%></td>
                                                <% }else
                                                  { %>
                                                    <td><input type="radio" name="cod102" value="0" disabled />  0-<% out.print(res.traduz(100,traducao));%></td>
                                                 <% } %>
                            ...
                            <tr>
                                <%		 
                                    if(rs.getString("cod102").equals("2"))
                                                    {%>
                                                        <td><input type="radio" name="cod102" value="1" checked disabled />  1-<% out.print(res.traduz(101,traducao));%></td>
                                                    <% }else
                                                      { %>
                                                        <td><input type="radio" name="cod102" value="1" disabled />  1-<% out.print(res.traduz(101,traducao));%></td>
                                                     <% } %>
                            </tr>
                    ...
                    <center><table>
                            ...
                            <tr>
                                ...
                                if(rs.getString("cod106").equals("1"))
                                                {%>
                                                   <td><input type="radio" name="cod106" value="0" checked disabled />  0-<% out.print(res.traduz(100,traducao));%></td>
                                                <% }else
                                                  { %>
                                                    <td><input type="radio" name="cod106" value="0" disabled />  0-<% out.print(res.traduz(100,traducao));%></td>
                                                 <% } %>
                                ...
                                if(rs.getString("cod106").equals("2"))
                                                {%>
                                                    <td><input type="radio" name="cod106" value="1" checked disabled />  1-<% out.print(res.traduz(101,traducao));%></td>
                                                <% }else
                                                  { %>
                                                    <td><input type="radio" name="cod106" value="1" disabled />  1-<% out.print(res.traduz(101,traducao));%></td>
                                                 <% } %>
                    ...
                    <table>
                            ...
                            <tr>
                                ...
                                if(rs.getString("cod108").equals("1"))
                                                {%>
                                                   <td><input type="radio" name="cod108" value="0" checked disabled />  0-<% out.print(res.traduz(100,traducao));%></td>
                                                <% }else
                                                  { %>
                                                    <td><input type="radio" name="cod108" value="0" disabled />  0-<% out.print(res.traduz(100,traducao));%></td>
                                                 <% } %>
                            ...
                            <tr>
                                ...
                                if(rs.getString("cod108").equals("2"))
                                                {%>
                                                    <td><input type="radio" name="cod108" value="1" checked disabled />  1-<% out.print(res.traduz(101,traducao));%></td>
                                                <% }else
                                                  { %>
                                                    <td><input type="radio" name="cod108" value="1" disabled />  1-<% out.print(res.traduz(101,traducao));%></td>
                                                 <% } %>
                            </tr>
                        </table>   
                 </div>
                ...
                <div class="field">
                    ...
                    <center> <table>
                        ...
                        if(rs.getString("cod142").equals("1"))
                                        {%>
                                            <td><input type="radio" name="cod142" value="0" checked disabled />  0-<% out.print(res.traduz(100,traducao));%></td>
                                        <% }else
                                          { %>
                                            <td><input type="radio" name="cod142" value="0" disabled />  0-<% out.print(res.traduz(100,traducao));%></td>
                                         <% } %>
                        ...
                        if(rs.getString("cod142").equals("2"))
                                        {%>
                                            <td><input type="radio" name="cod142" value="1" checked disabled />  1-<% out.print(res.traduz(101,traducao));%></td>
                                        <% }else
                                          { %>
                                            <td><input type="radio" name="cod142" value="1" disabled />  1-<% out.print(res.traduz(101,traducao));%></td>
                                         <% } %>
                    ...
                    <table>
                            ...
                            <tr>
                                ...
                                if(rs.getString("cod148").equals("1"))
                                                {%>
                                                    <td><input type="radio" name="cod148" value="0" checked disabled />  0-<% out.print(res.traduz(100,traducao));%></td>
                                                <% }else
                                                  { %>
                                                    <td><input type="radio" name="cod148" value="0" disabled />  0-<% out.print(res.traduz(100,traducao));%></td>
                                                 <% } %>
                            ...
                            <tr>
                               <%		 
                                if(rs.getString("cod148").equals("2"))
                                                {%>
                                                    <td><input type="radio" name="cod148" value="1" checked disabled  />  1-<% out.print(res.traduz(101,traducao));%></td>
                                                <% }else
                                                  { %>
                                                    <td><input type="radio" name="cod148" value="1" disabled />  1-<% out.print(res.traduz(101,traducao));%></td>
                                                 <% } %> 
                            </tr>
                        </table>   
                 </div>
	...
	%>
           ...
           <%-- <input type="submit" name="Submit"  class="button" value="<% out.print(res.traduz(240,traducao));%> >>" /> --%>   
