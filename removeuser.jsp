...
function confirmBox() {
    ...
    <body>
        ...
        <div id="migalhas">
            ...
            <a class="caminho" href="/SistemaGermo/removeuser.jsp" title="Ir para o Inicio"><% out.print(res.traduz(243,traducao));%></a> »
            <a class="caminho"><% out.print(res.traduz(210,traducao));%></a>
            <!--Include.-->
        </div>
       ...
       <%
	     ...
	     <form id="contactform" name="f1" class="rounded" method="post" action="remover.jsp">
		...
		<input type="button" id="sub" name="Submit"  class="button" value="<% out.print(res.traduz(210,traducao)); %>" onclick="confirmBox()" />
		</form> 
