<%-- 
    Document   : RelGeralEspecie
    Created on : 12/05/2015, 13:16:45
    Author     : Valdomiro
--%>
...
Font fi = new Font(FontFamily.TIMES_ROMAN,10,Font.ITALIC);
        ...
        try{
         ...
         try { 
              ...
              rs = st.executeQuery("select* from local_coleta as l,faseplantula as fp, fasevegetativa as fv,fasereprodutiva as fr where l.Codigo=fp.ID_Plantula and fp.ID_Plantula=fv.Identificador and fv.Identificador=fr.Identif order by especie ");
