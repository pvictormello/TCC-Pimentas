<%-- 
    Document   : RelatorioCor
    Created on : 07/05/2015, 14:47:46
    Author     : Valdomiro
--%>

<%@page import="com.itextpdf.text.Phrase"%>
<%-- 
    Document   : RelGeralPim
    Created on : 28/02/2015, 08:29:30
    Author     : Valdomiro
--%>
    ...
    <body>
     ...
     <%
       ...
       }else 
       {
           ...
           array2 = permis.split("-");
		    //out.print("Permissao "+array2[3].toString());
...
Font fi = new Font(FontFamily.TIMES_ROMAN,10,Font.ITALIC);
        ...
        try{
         ...
         try { 
              ...
              rs = st.executeQuery("select* from local_coleta as l,faseplantula as fp, fasevegetativa as fv,fasereprodutiva as fr where l.Codigo=fp.ID_Plantula and fp.ID_Plantula=fv.Identificador and fv.Identificador=fr.Identif and cor='"+escolha+"' ");
       ...
       String sHora = hformatador.format(dataAtual);
        ...
        //Paragraph rodape = new Paragraph("Relátorio gerado em: "+dataStr+" as "+sHora,ff); 
        document.add(rodape);
