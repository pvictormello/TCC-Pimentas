<%-- 
    Document   : imagens2
    Created on : 16/02/2015, 10:40:17
    Author     : Valdomiro
--%>
    ...
    <body>
	  ...
	  <%--  <li class=""><a href="#"><% out.print(res.traduz(225,traducao));%></a></li>
        ...
        <ul id="nav3">
            ...
            <li class="active"><a href="imagens2.jsp"><% out.print(res.traduz(248,traducao));%></a></li>
        </ul>
        <%
          ...
          %>
            ...
            <% if(temp.getTamanho(cod)>0){ %>
            <input type="button" name="Submit"  class="button" value="<% out.print(res.traduz(210,traducao));%> >>" onclick="confirmBox()" />
            <% } %>
           </form>
           </div>
